...
from tensorflow.keras.layers import Conv2D, Add, Flatten, BatchNormalization, LeakyReLU, ReLU, Input, concatenate,Dropout,Dense
...
model.fit(x_train, y_train, epochs=100, validation_split=0.3, batch_size=100)
